...
import { matchTrigger } from "@/agent-ui/script-engine/match"
import type { ImmersiveAgentAppProps, ImmersiveConversationMeta, ImmersiveConversationScene, MessageAttachment } from "@/agent-ui/immersive/contracts"

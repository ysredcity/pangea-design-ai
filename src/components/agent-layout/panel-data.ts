...
export const coffeeIndustryResearchReport = filePreview(
  "2024—2026中国现制咖啡行业调研报告.html",
  "HTML · 调研报告",
  "# 2024—2026 中国现制咖啡行业调研报告\n\n## 执行摘要\n\n中国现制咖啡市场仍处于高频扩张与结构分化并行阶段。大众价格带继续依赖门店密度、供应链效率和会员运营争夺份额；精品、茶咖融合与功能性产品则构成差异化增量。\n\n## 市场与竞争格局\n\n- 市场扩容由消费频次提升和门店网络下沉共同推动。\n- 头部品牌围绕价格带、门店效率与产品上新频率展开竞争。\n- 下沉市场增速更快，但对供应链稳定性和区域化选品提出更高要求。\n\n## 消费趋势\n\n- 低糖乳咖、地域风味与功能性原料的关注度持续上升。\n- 办公与下午茶场景贡献主要增量，非早餐时段仍有明显机会。\n- 茶咖融合产品在新品测试中展现出更高的复购潜力。\n\n## 新品规划建议\n\n1. 优先验证低糖乳咖与地域风味组合，建立可规模化复制的产品基线。\n2. 按城市层级测试价格带和渠道组合，降低全国同步上新的风险。\n3. 围绕下午时段设计轻负担、可分享的产品与会员触达机制。\n\n## 研究边界\n\n本报告基于 2024—2026 年公开行业研究、品牌财报与消费趋势资料整理，适用于新品规划阶段的方向判断与后续区域测试设计。",
  "2024—2026 中国现制咖啡行业调研报告",
)

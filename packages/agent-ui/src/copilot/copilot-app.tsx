...
import { ConversationPage } from '../immersive/agent-layout/conversation-page'
import { Composer, type ContextItem } from '../immersive/agent-layout/composer'
import { ArtifactPanel } from '../immersive/agent-layout/artifact-panel'
import { IconButton } from '../immersive/agent-layout/icon-button'
import { ImageViewer } from '../immersive/agent-layout/image-viewer'
import { splitSentContext } from '../immersive/agent-layout/message-context'
import type { ImageView, PanelTab, PanelView } from '../immersive/agent-layout/panel-types'
import { ConversationHistoryList, type Conversation } from '../immersive/agent-layout/sidebar'
import { smartReportConversations, smartReportPinnedConversations } from './smart-report-conversations'
import { Dialog, DialogContent } from '../immersive/ui/dialog'
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '../immersive/ui/dropdown-menu'
import { SidebarProvider } from '../immersive/ui/sidebar'
